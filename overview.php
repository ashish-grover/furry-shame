...
<head>
	<meta charset="utf-8">
	<title>Socially accepted user profile page[s]</title>
...
<body>
	<header>
		<div class="wrapper" >
			<a href="#">
				<img src="#" alt="pv logo" title="pv - where you get your money's worth"/>
			</a>
			<span id="usernav">
				<a href="#">
					Logout
			...
			<div id="userStats" class="clearfix">
				...
				<div class="data">
					...
					<div class="socialMediaLinks">
						<a href="http://twitter.com" rel="me" target="_blank"><img src="img/twitter-icon.png"/></a>
					</div>
					<div class="sep"></div>
					<ul class="numbers clearfix">
						<li>Reputation<strong>185</strong></li>
						<li>Checkin<strong>344</strong></li>
